...
import 'package:educativo_app/pages/components/AnswerButton.dart';
import 'package:educativo_app/pages/components/HeadingText.dart';
import 'package:educativo_app/pages/components/QuestionText.dart';

import 'ques2.dart';

//APP CONSTANTS
var _THEME_COLOUR_ = const Color(0xFF4CAF50);
...
class _Quiz2State extends State<Quiz2> {
  ...
  void check_ans(String value) {
    ...
    setState(() {
      ...
      if (solvedQues == 3) {
        isQuizStarted = false;
        score = "Pontuação : $finalScore/$totalQues";
        nextQue = "";
        op1 = "";
        op2 = "";
        op3 = "";
          ...
          Row(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  HeadingText(
                    "Questões: $solvedQues/$totalQues".toUpperCase(),
                  ),
